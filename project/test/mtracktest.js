...
describe('application launch', function () {
    ...
    it('show date and description and money',function(){
        assert.equal('12/25 | 搭捷運 | 15元',M.event_description('搭捷運','15'))
       })
       it('show date and description and money',function(){
        assert.equal('12/25 | 午餐 | 65元',M.event_description('午餐','65'))
       })
       it('show date and description and money',function(){
        assert.equal('12/25 | 買衣服 | 790元',M.event_description('買衣服','790'))
       })
})